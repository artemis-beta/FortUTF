MODULE FUTF_ASSERTIONS
    ...
    SUBROUTINE ASSERT_ALMOST_EQUAL_REAL_8BYTE(REAL_1, REAL_2, REL_TOL)
        ...
        IF(PASSES) THEN
            CALL REGISTER_PASSED
            WRITE(INFO, '(A, F0.5, A, F0.5, A, E0.5)') "ASSERT_ALMOST_EQUAL: ABS(", REAL_1, " - ", REAL_2, ") < ", TOLERANCE
        ELSE
            CALL REGISTER_FAILED
            WRITE(INFO, '(A, F0.5, A, F0.5, A, E0.5)') "ASSERT_ALMOST_EQUAL: ABS(", REAL_1, " - ", REAL_2, ") > ", TOLERANCE
        ENDIF
    ...
    SUBROUTINE ASSERT_ALMOST_EQUAL_REAL_4BYTE(REAL_1, REAL_2, REL_TOL)
        ...
        IF(PASSES) THEN
            CALL REGISTER_PASSED
            WRITE(INFO, '(A, F0.5, A, F0.5, A, E1.5)') "ASSERT_ALMOST_EQUAL: ABS(", REAL_1, " - ", REAL_2, ") < ", TOLERANCE
        ELSE
            CALL REGISTER_FAILED
            WRITE(INFO, '(A, F0.5, A, F0.5, A, E1.5)') "ASSERT_ALMOST_EQUAL: ABS(", REAL_1, " - ", REAL_2, ") > ", TOLERANCE
        ENDIF
