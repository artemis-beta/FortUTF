...
SUBROUTINE TEST_ASSERT_GT_FAIL_INT_1BYTE
    USE FORTUTF
    INTEGER(INT_KIND_1BYTE) :: X, Y
    X = 1
    Y = 4

    CALL TAG_TEST("TEST_ASSERT_GT_FAIL_INT_1BYTE")

    CALL ASSERT_GREATER_THAN(X, Y)

    CALL RESET_LAST_TEST_STATUS

END SUBROUTINE TEST_ASSERT_GT_FAIL_INT_1BYTE

SUBROUTINE TEST_ASSERT_GT_FAIL_INT_2BYTE
    USE FORTUTF
    ...
    CALL TAG_TEST("TEST_ASSERT_GT_FAIL_INT_2BYTE")

    CALL ASSERT_GREATER_THAN(X, Y)

    CALL RESET_LAST_TEST_STATUS

END SUBROUTINE TEST_ASSERT_GT_FAIL_INT_2BYTE

SUBROUTINE TEST_ASSERT_GT_FAIL_INT_4BYTE
    USE FORTUTF
    ...
    CALL TAG_TEST("TEST_ASSERT_GT_FAIL_INT_4BYTE")

    CALL ASSERT_GREATER_THAN(X, Y)

    CALL RESET_LAST_TEST_STATUS

END SUBROUTINE TEST_ASSERT_GT_FAIL_INT_4BYTE

SUBROUTINE TEST_ASSERT_GT_FAIL_INT_8BYTE
    USE FORTUTF
    ...
    CALL TAG_TEST("TEST_ASSERT_GT_FAIL_INT_8BYTE")

    CALL ASSERT_GREATER_THAN(X, Y)

    CALL RESET_LAST_TEST_STATUS

END SUBROUTINE TEST_ASSERT_GT_FAIL_INT_8BYTE